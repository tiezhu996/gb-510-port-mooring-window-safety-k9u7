...
type VesselCallHandler struct{ service service.VesselCallService }

func NewVesselCallHandler(s service.VesselCallService) *VesselCallHandler {
	return &VesselCallHandler{service: s}
}
